  ...
  var converters = {
    ...
    toSass: {
      ...
      "array": function (array, options) {
        ...
        var $list = new sass.types.List(array.length, separator);
      ...
      "sassjsnumber": function (number) {
        return new sass.types.Number(number.value, number.unit);
      },
      "sassjscolor": function (color) {
        return new sass.types.Color(color.r, color.g, color.b, color.a);
      },
      "number": function (number, options) {
        return new sass.types.Number(number, options.unit || "");
      },
      "boolean": function (bool) {
        return bool ? sass.types.Boolean.TRUE : sass.types.Boolean.FALSE;
      },
      "string": function (str) {
